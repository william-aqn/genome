...
% Discourage orphan \paragraph headings at page ends — require enough
% room below the heading for at least a few lines of the following content.
\let\oldparagraph\paragraph
\renewcommand{\paragraph}[1]{\needspace{5\baselineskip}\oldparagraph{#1}}

% Stronger penalties against widows and orphans.
\widowpenalty=10000
\clubpenalty=10000
...
\author{william-aqn\\
  ...
  \small \href{mailto:z@x-crm.in}{z@x-crm.in}\\
...
\smallskip
\noindent
\textbf{DOI:} \href{https://doi.org/10.5281/zenodo.19493628}{10.5281/zenodo.19493628} \hfill
